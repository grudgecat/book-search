...
const SavedBooks = () => {
  ...
  console.log('THIS IS THE ONE THAT CAUSES GRIEF ', userData);

  const [removeBook] = useMutation(REMOVE_BOOK); 

  // createfunction that accepts the book's mongo _id value as param and deletes the book from the database
